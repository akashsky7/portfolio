...
function About() {
  return (
    <div className="flex flex-col  bg-black text-white  text-center items-center p-10 min-h-screen">
      ...
      <div className="flex flex-row p-20 max-md:py-0 max-md:p-0">
        <div className="w-1/2 p-20 border-r-2 border-myblue max-md:border-none max-md:w-screen max-md:px-5">
          <p className="text-2xl text-left max-md:text-center max-md:text-lg">
        ...
        <div className="w-1/2 pl-20 max-md:hidden">
          <div>
            <p><ImageTable /></p>
          </div>
        </div>
      ...
      <Link to='/experience'>  
                <div className='mt-5 border rounded-3xl px-4 py-2 flex transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300 hover:border-myblue'>
